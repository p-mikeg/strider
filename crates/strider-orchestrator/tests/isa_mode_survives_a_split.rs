...
fn bytes() -> Vec<u8> {
    ...
    put_le32(&mut bytes, BASE, 0x1004, 0xe12f_ff10); // bx r0, first site
    put_le32(&mut bytes, BASE, 0x1020, 0xe1a0_4770); // ror r4, r0, r7
    put_le32(&mut bytes, BASE, 0x1024, 0xe1a0_5770); // ror r5, r0, r7
    put_le32(&mut bytes, BASE, 0x1028, 0xe12f_ff1e); // bx lr
    put_le32(&mut bytes, BASE, 0x1030, 0xe1a0_6770); // ror r6, r0, r7
    put_le32(&mut bytes, BASE, 0x1034, 0xe12f_ff11); // bx r1, second site
    put_le32(&mut bytes, BASE, 0x1038, 0xe1a0_7770); // ror r7, r0, r7
    put_le32(&mut bytes, BASE, 0x103c, 0xe12f_ff12); // bx r2, third site
    bytes
}
