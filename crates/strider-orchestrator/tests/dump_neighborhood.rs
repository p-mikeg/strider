//! Integration test: `strider_orchestrator::dump_neighborhood` emits an HTML
...
use common::dump_helpers::{
    ScratchDir, VIEWER_JSON_ANCHOR, lift_add_chain_snippet_x86_64, lift_ret_snippet_x86_64,
};
...
fn dump_neighborhood_writes_one_html_for_the_anchor() {
    ...
    strider_orchestrator::dump_neighborhood(
        &outcome.function,
        entry_node,
        /* depth */ 1,
        &sleigh,
...
fn dump_neighborhood_rejects_foreign_node_id() {
    ...
    let err = strider_orchestrator::dump_neighborhood(
        &outcome_a.function,
        foreign_id,
        /* depth */ 1,
        &sleigh,
