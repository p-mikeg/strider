...
//! previous function's body in, which on real binaries surfaces as a live
//! `IndirectBranch` placeholder from a branch in the NEIGHBOUR.
//!
...
/// `target_fn` under `fn_max_size`, even with the reach-back flag
