...
class OffsetCapture:
    """Opaque capture for an SP-relative stack offset bound by
    `LoadPat.offset_capture` / `StorePat.offset_capture`; read back via
...
class CallPat:
    ...
    Field-setter methods (`at`, `at_any`, `target`, `arg`, `ret_output`)
    return the same builder for chaining; finaliser methods (`capture`,
...
class CallOtherPat:
    ...
    `.arg(idx, p)` for individual arguments.  `.next_ctrl(p)` /
    `.next_mem(p)` walk forward to the unique consumer of the
    CallOther's control / memory output.
    """
    def user_op_id(self, v: int) -> "CallOtherPat": ...
    def name(self, n: str) -> "CallOtherPat": ...
    def arg(self, idx: int, p: PatLike) -> "CallOtherPat": ...
    def ret(self, idx: int, p: PatLike) -> "CallOtherPat": ...
    def ctrl(self, p: PatLike) -> "CallOtherPat": ...
    def mem(self, p: PatLike) -> "CallOtherPat": ...
    def ctrl_out(self, p: PatLike) -> "CallOtherPat": ...
    def mem_out(self, p: PatLike) -> "CallOtherPat": ...
...
class LoadPat:
    ...
    def offset_capture(self, c: OffsetCapture) -> "LoadPat": ...
    def capture(self, c: Capture) -> Pat: ...
    def cap(self, name: str) -> Pat: ...
    def when(self, f: Callable[[PartialMatch], bool]) -> Pat: ...
    def into_pat(self) -> Pat: ...
...
class StorePat:
    ...
    Chain `.addr(p)`, `.data(p)`, `.mem_in(p)`, `.next_mem(p)`,
    `.bit_width(n)`, `.space(s)`, `.stack_only()`, `.offset_capture(c)`.
    `.next_mem(p)` walks forward to the unique consumer of the store's
    memory output (no match if zero or multiple consumers).
    """
    ...
    def offset_capture(self, c: OffsetCapture) -> "StorePat": ...
    def capture(self, c: Capture) -> Pat: ...
    def cap(self, name: str) -> Pat: ...
    def when(self, f: Callable[[PartialMatch], bool]) -> Pat: ...
    def into_pat(self) -> Pat: ...
