...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let buf = vec![
        0xf3, 0x0f, 0x1e, 0xfa, 0x55, 0x48, 0x89, 0xe5, 0x48, 0x83, 0xec, 0x20, 0x89, 0x7d, 0xec,
        0x83, 0x7d, 0xec, 0x04, 0x75, 0x07, 0xb8, 0x01, 0x00, 0x00, 0x00, 0xeb, 0x39, 0x90, 0x83,
        0x7d, 0xec, 0x05, 0x75, 0x07, 0xb8, 0x03, 0x00, 0x00, 0x00, 0xeb, 0x2b, 0xc7, 0x45, 0xfc,
        0x00, 0x00, 0x00, 0x00, 0xeb, 0x16, 0x8b, 0x45, 0xec, 0x48, 0x98, 0x48, 0x89, 0xc7, 0xb8,
        0x00, 0x00, 0x00, 0x00, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x83, 0x45, 0xfc, 0x01, 0x83, 0x7d,
        0xfc, 0x02, 0x7e, 0xe4, 0x83, 0x6d, 0xec, 0x01, 0xeb, 0xc8, 0xc9, 0xc3,
    ];
    ...
    let mut builder = FunctionBuilder::new_raw(vns.clone(), &[], &[rbx], &[rax], None, 0)?;
    ...
    let dot = strider_ir::dot::GraphDot::new(function.dot_dumper(&sleigh), strider_ir::dot::DotStyle::dark());
