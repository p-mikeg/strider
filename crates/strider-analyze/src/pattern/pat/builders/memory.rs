...
use crate::pattern::pat::node_pat::{InputsSpec, KindSpec, NodeKindCheck, NodePat};
...
/// Builder for `StackStore` node patterns.  Created by [`crate::pattern::pat::stack_store`].
...
impl StackStorePat {
    ...
    /// contract of [`crate::pattern::int_const_any_of`].
    #[must_use]
...
/// Builder for `StackStorePhi` node patterns.  Created by [`crate::pattern::pat::stack_store_phi`].
