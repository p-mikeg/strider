...
//! [`crate::opt::CfgDetach`]'s sole responsibility now.
...
///
/// Works together with [`crate::opt::CfgDetach`] (which removes the dead
/// `Region` predecessor slot) and [`crate::opt::PhiCollapse`] /
/// [`crate::opt::RegionCollapse`] (which collapse the now-single-pred join).
#[derive(Clone, Copy)]
