...
use super::sections::{LoadFilter, RegionSource, elf_get_loadable_regions};
...
impl ElfFileMemReader {
    ...
    /// [`super::sections::ElfSectionLayout`] bases for ET_REL. See
    ...
    pub fn from_object(obj: &object::File<'_>) -> Result<Self> {
        Self::over(elf_get_loadable_regions(obj)?, obj)
    }
    ...
    fn over(regions: Vec<crate::MemRegion>, obj: &object::File<'_>) -> Result<Self> {
        Ok(Self {
            lookup: MemRegionsLookupTable::new(regions),
            writable: super::sections::elf_writable_fetch_ranges(obj)?,
        })
    }
