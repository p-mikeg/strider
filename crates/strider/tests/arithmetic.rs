...
fn has_add(g: &strider_ir::BuiltFunctionGraph) {
...
fn has_sub(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
        count_int_unop(g, IntUnaryOp::Neg) >= 1,
        "expected ≥1 IntUnaryOp::Neg (the lowered Sub form)"
    );
}
fn has_mul(g: &strider_ir::BuiltFunctionGraph) {
...
fn has_div(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
...
fn has_rem(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
...
fn has_sdiv(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
...
fn has_srem(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
...
fn has_and(g: &strider_ir::BuiltFunctionGraph) {
    assert!(count_int_binop(g, IntBinaryOp::And) >= 1, "expected ≥1 And");
}
fn has_or(g: &strider_ir::BuiltFunctionGraph) {
    assert!(count_int_binop(g, IntBinaryOp::Or) >= 1, "expected ≥1 Or");
}
fn has_xor(g: &strider_ir::BuiltFunctionGraph) {
...
// covers both arches.
fn has_neg(g: &strider_ir::BuiltFunctionGraph) {
    assert!(
        count_int_unop(g, IntUnaryOp::Neg) >= 1,
