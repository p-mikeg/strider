...
/// `1 << w`.  A shape the replay cannot model exactly, and a scale past the
/// `u128` carrier, both answer "width-only", which defers the site rather than
/// enumerating a cell.  `w < 128` keeps the shift well-defined.
