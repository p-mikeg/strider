//! Test-only graph DSL — mock graph for testing graph-walking
//! algorithms.
//!
//! Absorbed from the standalone `graphmock` crate / `graphwalk` test
//! helper. See `docs/superpowers/plans/2026-05-17-strider-v2-rewrite.md`
//! Phase 1 Task 1.2.
//!
//! `&Graph` implements [`crate::graphwalk::GraphRef`] and
//! [`crate::graphwalk::PredGraphRef`], so it plugs straight into
//! [`crate::graphwalk::PreOrder`] / [`crate::graphwalk::PostOrder`].
...
use crate::graphwalk::{GraphRef, PredGraphRef};
