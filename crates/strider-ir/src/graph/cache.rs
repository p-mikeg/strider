...
//! supplying the three [`strider_graph::NodeCacheable`] hooks the mechanism
//! consults:
//!
...
//!
//! `IntConst` payload masking (narrow constants masked to their declared integer
//! output width) is NOT the cache's concern.  It is handled at construction time
//! by [`crate::Function::create_node_attributed`], which is the single
//! choke-point all production creation routes go through.
